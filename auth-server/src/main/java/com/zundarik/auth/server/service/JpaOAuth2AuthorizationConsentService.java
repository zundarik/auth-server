package com.zundarik.auth.server.service;

import com.zundarik.auth.server.domain.AuthorizationConsent;
import com.zundarik.auth.server.repository.AuthorizationConsentRepository;
